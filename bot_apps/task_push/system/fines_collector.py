...
from bot_apps.personal_task.adding_task.adding_task_text import round_numbers
from bot_apps.personal_task.personal_task_keyboards import collect_fines_keyboard
from bot_apps.wordbank import personal_task
from config import load_config
from databases.database import db, AllFinesInfo, FineInfo
...
async def _send_message_for_fine(tg_id: int, fines_list: list[FineInfo]) -> None:
    ...
    await bot.send_message(chat_id=tg_id,
                           ...
                           reply_markup=collect_fines_keyboard(
                               await db.get_send_id(_get_fines_id(fines_list))))
