...
from bot_apps.personal_task.adding_task.adding_task_filters import is_correct_profile_link, is_correct_post_link, \
    is_correct_words_or_tags, is_correct_note
from bot_apps.personal_task.adding_task.adding_task_keyboards import select_actions_builder, setup_all_components_builder, \
...
from bot_apps.personal_task.adding_task.adding_task_text import task_setting_text_builder, \
...
from bot_apps.task_push.system.sending_tasks.start_task import start_tasks
